data=read.csv("/Users/mohanasaikumarreddy/Downloads/github/Assignment1/Question1/data_raw/data-raw-file.csv")
...
write.csv(data,"/Users/mohanasaikumarreddy/Downloads/github/Assignment1/Question1/data_clean/clean_data.csv")
